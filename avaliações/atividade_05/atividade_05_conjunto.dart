void main() {
  ...
  print("05) Observe que o nome Lucas não é replicado: ${conjunto}"); // {Lucas, Sara}

  //06) Como remover um elemento de um conjunto em Dart?
  conjunto.remove('Lucas');
  print("06) Conjunto após remoção: ${conjunto}"); // {Sara}
  ...
  print("09) ${conjunto_uniao}"); // {Sara, Brasília, Fortaleza, São Paulo}

  //10) Como obter a interseção de dois conjuntos em Dart?
  print("10) ${conjunto_1.intersection(cidade)}"); // {Fortaleza}

  //11) Como obter a diferença entre dois conjuntos em Dart?
  print("11) ${conjunto_1.difference(cidade)}"); // {Brasília, São Paulo}
  ...
  print("16) ${set_to_list_int_to_string}"); // [1, 4, 2, 7]
  ...
  print("17) ${conj_uniao}"); // {Sara, Brasília, Fortaleza, São Paulo, 1, 4, 2, 7}
